...
!https://img.shields.io/badge/ROS2-Humble%2FIron-blue?logo=ros&logoColor=white
!https://img.shields.io/badge/Python-3.10+-yellow?logo=python&logoColor=white
!https://img.shields.io/badge/Build-Colcon-orange
...
系统严格遵循 https://www.ros.org/reps/rep-0105.html 标准：
graph TD;
    map --> odom;
    odom --> base_link;
    base_link --> laser;
